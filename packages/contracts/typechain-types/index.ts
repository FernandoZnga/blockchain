...
export type { EduToken } from "./contracts/EduToken";
export { EduToken__factory } from "./factories/contracts/EduToken__factory";
export type { TransactionRegistry } from "./contracts/TransactionRegistry";
export { TransactionRegistry__factory } from "./factories/contracts/TransactionRegistry__factory";
